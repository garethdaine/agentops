...
export default function AgentDetailPanel() {
  ...
  return (
    <div className="absolute -top-4 -right-4 bottom-8 w-[380px] z-50 bg-gray-900/95 backdrop-blur-sm border border-gray-700 rounded-xl shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-right-10 duration-300">
      {/* Header */}
